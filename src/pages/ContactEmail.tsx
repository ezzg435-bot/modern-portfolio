...
${formData.email}`;
    ...
    const mailtoLink = `mailto:aegis@strelixcloud.com?subject=${encodeURIComponent(emailSubject)}&body=${encodeURIComponent(emailBody)}`;
